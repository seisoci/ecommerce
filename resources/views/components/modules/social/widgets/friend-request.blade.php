@props(['friendrequestimg','friendrequesttitle','friendrequestdec','friendrequest','newfriendrequest'])
<li class="d-flex align-items-center gap-3 justify-content-between border-bottom mb-3 pb-3 flex-column flex-md-row">
    <div class="user-img img-fluid flex-shrink-0">
    <img src="{{asset('modules/social-app/images/avatar')}}/{{$friendrequestimg}}" alt="story-img" class="rounded-circle avatar-40">
    </div>
    ...
    @if($friendrequest ?? '' == 'true')
        <div class="confirm-click-btn">
            <a href="javascript:void(0)" class="me-3 btn btn-primary rounded confirm-btn">Confirm</a>
            <a href="#" class="btn btn-secondary rounded delete-btn">Delete Request</a>
        </div>
    @endif
    @if($newfriendrequest ?? '' == 'true')
        <div class="d-flex align-items-center mt-2 mt-md-0">
            <a href="javascript:void(0)" class="me-3 btn btn-primary rounded">
