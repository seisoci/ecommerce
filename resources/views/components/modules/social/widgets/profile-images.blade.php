@props(['fslightboximg','profileImagesimg','profileImagesDetail1','profileImagesDetail2','profileImagesDetail3'])
<div class="user-images position-relative overflow-hidden">
    <a data-fslightbox="gallery" href="{{asset('modules/social-app/images/profile-event')}}/{{$fslightboximg}}">
    <img src="{{asset('modules/social-app/images/profile-event')}}/{{$profileImagesimg}}" class="img-fluid rounded" alt="Responsive image" loading="lazy">
    </a>
