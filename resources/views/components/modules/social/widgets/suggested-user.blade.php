...
<div class="d-flex justify-content-center">
    <img src="{{asset('modules/social-app/images')}}/{{$userAvatar}}" class="img-fluid avatar-48 rounded-circle me-3" alt="profile-image-1">
    <div class="d-flex align-items-center justify-content-between flex-grow-1">
        <div class="me-3">
            <h5>{{$userName}}</h5>
            <small class="social-para-ellipsis-1">{{$userComment}}</small>
        </div>
        <div>
