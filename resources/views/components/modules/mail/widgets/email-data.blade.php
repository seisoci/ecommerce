...
<li class="iq-unread">
    <div class="d-flex align-self-center iq-unread-inner">
        <div class="iq-email-sender-info d-flex align-items-center">
        ...
        <div class="iq-email-content">
            <a href="javascript:void(0)" class="iq-email-subject">{{$subjectName}} -
                <span class="text-secondary">{{$emailmessage ?? ''}}</span>
            </a>
            <div class="iq-email-date text-secondary">{{$mailTime}}</div>
        </div>
            ...
            <div class="card-body">
                ...
                <div class="d-flex justify-content-start mt-4">
                    ...
                    <div class="ms-2">
                        ...
                        <div class="dropdown">
                            to me
                            <svg xmlns="http://www.w3.org/2000/svg"  id="dropdownMenuLink-{{$id ?? ''}}" data-bs-toggle="dropdown" aria-expanded="false" width="10" viewBox="0 0 10 6" fill="none" role="button">
                                <path d="M9 1L5 5L1 1" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                            </svg>
                            <table class="bg-white dropdown-menu p-3" aria-labelledby="dropdownMenuLink-{{$id ?? ''}}">
                                <tr>
                                    <th>from:</th>
                ...
                <div class="row">
                    <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12">
                        <div class="bg-soft-primary rounded mb-4">
                ...
                <div class="row">
                    <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 mb-4">
                        <img class="img-fluid w-100 rounded-1" src="{{asset('modules/mail/images/01.png')}}" alt="email-img">
                    </div>
                    <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 mb-4">
                        <img class="img-fluid w-100 rounded-1" src="{{asset('modules/mail/images/02.png')}}" alt="email-img">
                    </div>
                    <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 mb-4">
                        <img class="img-fluid w-100 rounded-1" src="{{asset('modules/mail/images/03.png')}}" alt="email-img">
                    </div>
                    <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12">
                        <img class="img-fluid w-100 rounded-1" src="{{asset('modules/mail/images/01.png')}}" alt="email-img">
                    </div>
